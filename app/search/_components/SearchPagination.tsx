      ...
      <div className="page_width pagination_container">
        {currentSelectedPage && (
          <div className="pagination">
            ...
            {currentSelectedPage === currentNoOfPages - 1
              ? noOfPages
                  .slice(currentSelectedPage - 2, currentSelectedPage)
                  .map((pageNo) => (
                    <button
                      type="button"
                      key={pageNo}
              ...
              : currentSelectedPage === currentNoOfPages - 2
              ? noOfPages
                  .slice(currentSelectedPage - 2, currentSelectedPage + 1)
                  .map((pageNo) => (
                    <button
              ...
              : currentSelectedPage > 3 &&
                currentSelectedPage < currentNoOfPages - 1
              ? noOfPages
                  .slice(currentSelectedPage - 2, currentSelectedPage + 2)
                  .map((pageNo) => (
                    <button
                      type="button"
                      key={pageNo}
              ...
              : currentNoOfPages <= 4
              ? noOfPages.slice(0, currentSelectedPage + 1).map((pageNo) => (
                  <button
                    type="button"
                    key={pageNo}
                    onClick={() => goToPage(pageNo)}
        ...
        <p className="sort_text">
          Showing {noOfListings}+ results sorted by <span>date published</span>
        </p>
      </div>
    </section>
  );
